...
class Seq2SeqAE():
    ...
    def create(self,
        ...
        encoder_lstm_1 = LSTM(lstm_size, return_sequences=True, name='enc_lstm_1')(encoder_inputs)
        encoder_lstm   = LSTM(lstm_size, return_state=True, name='enc_lstm_2')
        ...
        decoder_lstm_1 = LSTM(lstm_size, return_sequences=True, name='dec_lstm_1')(decoder_inputs, initial_state=encoder_states)
        decoder_lstm   = LSTM(lstm_size, return_sequences=True, return_state=True, name='dec_lstm_2')
        ...
        decoder_state_input_h = Input(shape=(lstm_size,), name='dec_input_h')
        decoder_state_input_c = Input(shape=(lstm_size,), name='dec_input_c')
        #decoder_masks_input = Input(shape=(None, num_decoder_tokens), name='dec_input_m')#masks
        decoder_states_inputs = [decoder_state_input_h, decoder_state_input_c]
        decoder_lstm_1 = LSTM(lstm_size, return_sequences=True, name='dec_lstm_1')(decoder_inputs, initial_state=decoder_states_inputs)
        decoder_outputs, state_h, state_c = decoder_lstm(decoder_lstm_1)
